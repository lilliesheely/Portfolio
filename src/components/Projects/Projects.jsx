           ...
           <div id='projects'></div>
            ...
            <div className='project-section'>
                <div className="project-ind">
                    ...
                    <div class="overlay">
                        <div class="text">
                            <p> <img src="https://i.imgur.com/ZsHWagj.png" width='200' height='101' alt="" /><a href="https://brewery-bucket-list.herokuapp.com/" target="_blank" rel="noreferrer">Deployed App</a> <br /> <a href="https://github.com/lilliesheely/Brewery-Bucket-List" target="_blank" rel="noreferrer">GitHub</a> <br /> JS | MongoDB | Mongoose | Express | React | Node.js | HTML | CSS </p>
                        </div>
                    </div>
                </div>
